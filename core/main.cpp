...
//	co::EVar<co::EFloat64> v_Acetic(0.138,0.1,5);
//	co::EVar<co::EFloat64> v_general_decay_rate(8.3E-04,0.00001,1);
	co::EVar<co::EFloat64> v_MO_acetoM(1.0,0.01,5);
	co::EVar<co::EFloat64> v_MO_Propionic(1.0,0.01,5);
	co::EVar<co::EFloat64> v_MO_ButyricValeric(1.0,0.01,5);	
