...
int main(){
	co::EVar<co::EFloat64> v_acetic(1.00,001,200);
	co::EVar<co::EFloat64> v_general_decay_rate(1.00,001,2);
	co::EVarManager<co::EVar<co::EFloat64>> vars;
	...
	//co::run_parameter_estimator(path,
	//co::EFloat<double>(5);
	//std::cout<<var.min;
}